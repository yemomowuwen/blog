$(function(){
    ...
    $(".login_form_con").submit(function (e) {
        // 阻止表单默认提交行为 自己使用ajax来提交数据
        e.preventDefault()
        var email = $(".login_form #mobile").val()
    ...
    $(".register_form_con").submit(function (e) {
        // 阻止表单默认提交操作 event：点击表单提交的事件
        // 自己使用ajax来提交
        e.preventDefault()

		// 取到用户输入的内容
        var email = $("#register_mobile").val()
...
function sendSMSCode() {
    ...
    var email = $("#register_mobile").val();
    if (!email) {
        $("#register-mobile-err").html("请填写正确邮箱！");
        $("#register-mobile-err").show();
...
function getCookie(name) {
    // csrf_token = sadlsakdksadsajk
    var r = document.cookie.match("\\b" + name + "=([^;]*)\\b");
    // sadlsakdksadsajk csrf_token的真实值
